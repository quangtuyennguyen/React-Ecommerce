...
import { CommentItem } from '../../components/PostDetails/PostComments/CommentItem/CommentItem';
import { CommentList } from '../../components/PostDetails/PostComments/CommentList/CommentList';
import { PostRelated } from '../../components/PostDetails/PostRelated/PostRelated';
import { PostWrapper } from '../../components/PostDetails/PostWrapper/PostWrapper';

const PostDetails = ({
    posts, displayName,
    addReplyRequest,
    addPostCommentRequest,
    postComments, toggleLoading,
    showModal
}) => {
