...
import { ProductAdminItem } from '../../components/ProductAdminItem/ProductAdminItem';
import { filterByCategory, searchProduct } from '../../utils';

const Admin = ({ products,
    showModal, hideModal,
    fetchProductEdit, clearProductEdit,
    removeProductRequest, toggleLoading,
    isAdminAuth
}) => {
    ...
    const renderProducts = () => (
        _.map(filterProducts().slice(start, end), ({ id, title, subTitle,
            images, rating, price, sizes,
    ...
    return (
        <Fragment>
            <section id="section-admin" className="u-margin-top-medium u-margin-bottom-big">
                <AdminHeader
                    ...
                    <table>
                        <thead>
                            {filterProducts().length ? (
                                <tr>
                                    <th style={{ width: '12.5%' }}>
                                        <h4 className="table-admin__heading table-admin__heading--main">Image</h4>
                                    </th>
                                    <th style={{ width: '27.5%' }}>
                                        <h4 className="table-admin__heading table-admin__heading--main">Title</h4>
                                    </th>
                                    <th style={{ width: '40%' }}>
                                        <h4 className="table-admin__heading table-admin__heading--main">Details</h4>
                                    </th>
                                    <th style={{ width: '20%' }}>
                                        <h4 className="table-admin__heading table-admin__heading--main">Actions</h4>
                                    </th>
                                </tr>
                            ) : null
                            }
