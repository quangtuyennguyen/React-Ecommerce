        ...
        case types.CHANGE_PRODUCT_QUANTITY:
            ...
            if (typeof value === 'number') {
                if (value === -1 && state[indexChange].quantity === 1) {
                    cartChanged = [...Object.assign([...state], { [indexChange]: { ...state[indexChange], quantity: 1 } })];
                } else {
                    cartChanged = [...Object.assign([...state], { [indexChange]: { ...state[indexChange], quantity: state[indexChange].quantity + value } })];
                }
            } else {
                cartChanged = [...Object.assign([...state], { [indexChange]: { ...state[indexChange], quantity: Math.round(parseInt(value)) } })];
            };
            return cartChanged;
