    ...
    const renderReplys = () => (
        _.map(replys, ({
            ...
            date, username
                ...
                <div key={id} className="post-comment__item post-comment__item--child u-border-none">
                    <div className="post-comment__image-box">
                        <img className="post-comment__image" src={useravatar}
                            alt="" />
                    </div>
                    <div className="post-comment__box-text">
                        <div className="post-comment__details">
                            <h6 className="post-comment__title">{username}
                                <span
