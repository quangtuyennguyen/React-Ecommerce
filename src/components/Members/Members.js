...
export const Member = () => {
    ...
    const renderRows = () => {
        ...
        for (let i = 0; i < rows; i++) {
            result.push(<div key={i} className="row members">
                { renderMembers().slice(memberPerRow * i, memberPerRow * i + memberPerRow) }
            </div>)
        };
        return result;
    };
        ...
        <section id="section-team">
            <div className="row u-center-text">
                <div className="heading-title u-margin-center">
                    <span className="heading-title--sub heading-title--sub--bold">ANGELS</span>
