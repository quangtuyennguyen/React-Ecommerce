    ...
    return (
        <div className="product-details">
            <div className="product-details__content">
                {modal && <div className="product-details__heading">
                    ...
                    <div className="row">
                        <div className="col span_3_of_5">
                            <CarouselProvider settings={{
                                ...oneSidePerRowSettings, arrows: false, customPaging: i => (
                        ...
                        <div className="col span_2_of_5">
                            <div className="product">
                                <div className="product__details">
                                    <h4 className="product__title product__title--big">{title}</h4>
                                    <p className="product__category">Category:
                                    <Link to={`/product-category/${_.kebabCase(category)}`}>{` ${category}`}</Link>
                                    </p>
                                    <div className="product__heading">
                                        <div className="product__rating">
                                            {renderRating(rating)}
                                            {totalComments ? <a href={`/product/${slug(title.toLowerCase())}.${id}#section-wrapper-tabs`}>{totalComments} Reviews</a> : null}
                                        </div>
                                        <i onClick={handleAddToWishList} className="far fa-heart" />
                                    </div>
                                    <div className="product__box-price">
                                        <span className="product__price product__price-p-new">{formatter.format(price)}</span>
                                ...
                                <div className="product__info">
                                    <h5 className="product__info-title product__info-title--big">
                                        <i className="fas fa-exclamation-circle" /> Product info</h5>
                                    <h6 className="product__info-title product__info-title--small"> Style</h6>
                                    <ul className="product__info-list">
                                        <li className="product__info-item">Hooded top</li>
                                    </ul>
                                    <h6 className="product__info-title product__info-title--small"> Composition</h6>
                                    <ul className="product__info-list">
                                        <li className="product__info-item">Elastic rib: Cotton 95%, Elastane 5%</li>
                                        <li className="product__info-item">Cotton 80%, Polyester 20%</li>
