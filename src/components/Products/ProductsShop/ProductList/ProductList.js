...
import SideBar from '../../../../components/Sidebars/ShopSideBar/SideBar';
        ...
        <div className="row u-padding-horizontal banner u-d-flex-center">
            <div className="col span_1_of_2">
                <div className="banner__details">
                    <span className="banner__heading banner__heading--sub">Converse All Star</span>
                    <h4 className="banner__heading banner__heading--main">Make Your Day Comfortable</h4>
                    <a href="/" className="btn btn--small btn--secondary">Show now</a>
                </div>
            </div>
            <div className="col span_1_of_2">
                <img src="https://demo.createx.studio/cartzilla/img/shop/catalog/banner.jpg" alt="" className="banner__img" />
            </div>
        </div>
    );
        ...
        for (let i = 0; i < rows; i++) {
            if (name === 'Grid') {
                resultProducts.push(
                    <Fragment key={i}>
                        <div
                            className="row u-padding-horizontal">
                            {productsCurrent.slice(productPerRow * i, productPerRow * i + productPerRow)}
                        </div>
