    ...
    return (
            <div className="post">
                ...
                <div className="post__details">
                    <Link to={`/blog/${slug(title.toLowerCase())}.${id}`}>
                        <h4 className="post__title post__title--small">{_.capitalize(title)}</h4>
                    </Link>
                    <p className="post__desc post__desc--ellipsis">{body}</p>
                    <div className="btn-group">
                        {_.map(tags, tag => (
                            <a key={tag} href="/" className="btn btn--outline--small">{tag}</a>
                        ))}
                    </div>
                </div>
                <a href="/">
                        ...
                        <div className="post__author">
                            <div className="post__author-details">
                                <div className="post__author-outline">
                                    <img className="post__author-avt" src={useravatar} alt={title} />
                                </div>
