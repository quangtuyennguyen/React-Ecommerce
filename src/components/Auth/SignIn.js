        ...
        <div className="modal modal-auth">
            <div className="modal-auth__content">
                <div className="modal-auth__heading">
                    ...
                    <span onClick={hideModal} className="modal__hide">×</span>
                </div>
                        ...
                        {({ handleSubmit, errors, touched }) => (
                            <Form className="form" onSubmit={handleSubmit} autoComplete="off">
                                <div className="form__group">
                                    ...
                                    {touched.email && <span style={{ marginTop: '1rem' }} className="form__text-error">{errors.email || errEmail}</span>}
                                </div>
                                <div className="form__group">
                                    ...
                                    {touched.password && <span style={{ marginTop: '1rem' }} className="form__text-error">{errors.password || errPassword}</span>}
                                    <i
                                ...
                                <div className="form__group u-d-flex-center">
                                    <div className="form__text form__text--left">
                                        <input className="checkbox" type="checkbox" name="checkbox" id="remember" />
                                ...
                                <div className="btn-group u-d-flex-center-left">
                                    ...
                                    <button type="button" onClick={signInWithGoggle} className="btn modal-auth__btn btn--white">Google</button>
                                </div>
                            </Form>
                        )}
                    </Formik>
