            ...
            <div className="comment u-border-small">
                <div className="comment__author-box u-d-flex-left">
                    ...
                    <div>
                        ...
                        <p className="comment__rating-desc">83% of users found this review  helpful</p>
                    </div>
                </div>
                ...
                <div className="comment__like-box u-d-flex-left">
                    <div
                        className={classnames('comment__like', { 'active': liked })}>
                        <i onClick={this.handleClickLike} className="far fa-thumbs-up" />
                        <span>{like}</span>
                    </div>
                    <div
                        className={classnames('comment__dislike', { 'active': disliked })}>
                        <i onClick={this.handleClickDislike} className="far fa-thumbs-down" />
                        <span>{dislike}</span>
                    </div>
                </div>
            </div>
