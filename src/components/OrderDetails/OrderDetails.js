...
function OrderDetails({ children, totalPrice }) {
    ...
    return (
        <Fragment>
            ...
            <section id="section-order-details" className="order-details u-margin-top-medium u-margin-bottom-medium">
                <div className="row">
                    <p className="order-details__text">Thank you. Your order has been received.</p>
                    <ul className="order-stat">
                        ...
                        <li className="order-stat__item">
                            ...
                            <h5 className="order-stat__text-main order-stat__text-main--blue">{formatter.format(totalPrice * 1.01)}</h5>
                        </li>
                        <li className="order-stat__item">
